...
constexpr const WORD  g_wMajorVersion   = 1;  ///< Protocol major version (i.e. 1.x)
constexpr const WORD  g_wMinorVersion   = 1;  ///< Protocol minor version (i.e. x.3)

 /// CNP Validation Key
constexpr const DWORD g_dwValidationKey = 0x00DEAD01;

/// [first,last,email] name field lengths
/**
 *  @sa CNP_CREATE_ACCOUNT_REQUEST, CNP_LOGON_REQUEST
 */
constexpr const size_t MAX_NAME_LEN     = 32;

 /// Used for error checking & default initialization
constexpr const WORD   INVALID_CLIENT_ID = static_cast<WORD>(~0);
 /// Used for error checking & default initialization
constexpr const WORD   INVALID_PIN = 0;
...
struct TRANSACTION
{
    ...
    inline DWORD get_Amount(void) const
    { return m_dwAmount; };

    inline const QWORD& get_DateTime(void) const
    { return m_qwDateTime; };

    inline TRANSACTION_TYPE get_Type(void) const
...
#ifndef _MSC_VER
    constexpr _CREATE_ACCOUNT_RESPONSE(DWORD dwResult = cnp::CER_ERROR)
        : m_dwResult(dwResult)
    { };
#endif
};
...
#ifndef _MSC_VER
    constexpr _LOGON_RESPONSE(DWORD dwResult = cnp::CER_ERROR)
        : m_dwResult(dwResult)
    { };
#endif
};
...
#ifndef _MSC_VER
    constexpr _LOGOFF_RESPONSE(DWORD dwResult = cnp::CER_ERROR)
        : m_dwResult(dwResult)
    { };
#endif
};
...
struct _DEPOSIT_REQUEST
{
    ...
    /// Initialization constructor
    constexpr _DEPOSIT_REQUEST(DWORD dwAmount = 0, DEPOSIT_TYPE Type = DT_INVALID)
        : m_dwAmount(dwAmount),
...
#ifndef _MSC_VER
    constexpr _DEPOSIT_RESPONSE(DWORD dwResult = cnp::CER_ERROR)
        : m_dwResult(dwResult)
    { };
#endif
};
...
struct _WITHDRAWAL_REQUEST
{
    ...
    /// Default constructor
    constexpr _WITHDRAWAL_REQUEST()
        : m_dwAmount(0)
    { };

    /// Initialization constructor
    constexpr _WITHDRAWAL_REQUEST(DWORD dwAmount)
        : m_dwAmount(dwAmount)
    { };
};
...
#ifndef _MSC_VER
    constexpr _WITHDRAWAL_RESPONSE(DWORD dwResult = cnp::CER_ERROR)
        : m_dwResult(dwResult)
    { };
#endif
};
...
struct _STAMP_PURCHASE_REQUEST
{
    ...
    /// Default constructor
    constexpr _STAMP_PURCHASE_REQUEST()
        : m_dwAmount(0)
    { };

    /// Initialization constructor
    constexpr _STAMP_PURCHASE_REQUEST(DWORD dwAmount)
        : m_dwAmount(dwAmount)
    { };
};
...
#ifndef _MSC_VER
    constexpr _STAMP_PURCHASE_RESPONSE(DWORD dwResult = cnp::CER_ERROR)
        : m_dwResult(dwResult)
    { };
#endif
};
...
struct _TRANSACTION_QUERY_REQUEST
{
    ...
    /// Default constructor
    constexpr _TRANSACTION_QUERY_REQUEST()
        : m_dwStartID(0),
          m_wTransactionCount(0)
    { };

    /// Initialization constructor
    constexpr _TRANSACTION_QUERY_REQUEST(DWORD dwStartID, WORD wTransactionCount)
...
#ifndef _MSC_VER
    constexpr _TRANSACTION_QUERY_RESPONSE(DWORD dwResult = cnp::CER_ERROR, WORD wTransactionCount = 0)
        : m_dwResult(dwResult),
          m_wTransactionCount(wTransactionCount)
    { };
#endif

    inline WORD get_TransactionCount(void) const
...
{
    constexpr _BALANCE_QUERY_REQUEST()
    { };
};
...
#ifndef _MSC_VER
    constexpr _BALANCE_QUERY_RESPONSE(DWORD dwResult = cnp::CER_ERROR, DWORD dwBalance = 0)
        : m_dwResult(dwResult), m_dwBalance(dwBalance)
    { };
#endif

    inline DWORD get_Balance(void) const
    { return m_dwBalance; };
};
 ...
 */
    ...
    /// Copy Constructor
    constexpr STD_HDR(const STD_HDR& rhs)
    ...
    inline DWORD get_MsgType(void) const
    { return m_dwMsgType; };

    inline WORD  get_ClientID(void) const
    { return m_wClientID; };

    inline DWORD get_Sequence(void) const
    { return m_dwSequence; };

    inline DWORD get_Context(void) const
    { return m_dwContext; };
};
...
// Server Decoding Helper Methods
    ...
    inline WORD       get_ClientMajorVersion(void) const
    { return m_Request.m_wMajorVersion; };

    inline WORD       get_ClientMinorVersion(void) const
    { return m_Request.m_wMinorVersion; };

    inline DWORD      get_ClientValidationKey(void) const
 ...
 */
    CONNECT_RESPONSE(DWORD dwResult,
                     WORD  wClientID,
                     WORD  wMajorVersion,
                     WORD  wMinorVersion,
                     DWORD dwSequence, 
    ...
    inline DWORD    get_ResponseResult(void) const
...
// Server Decoding Helper Methods
    ...
    inline const char* get_FirstName(void) const
    { return m_Request.m_szFirstName; };

    inline const char* get_LastName(void) const
    { return m_Request.m_szLastName; };

    inline const char* get_EmailAddress(void) const
    { return m_Request.m_szEmailAddress; };
    
    inline WORD        get_PIN(void) const
    { return m_Request.m_wPIN; };

    inline DWORD       get_SSNumber(void) const
    { return m_Request.m_dwSSNumber; };

    inline DWORD       get_DLNumber(void) const
...
/// Default constructor
    constexpr CREATE_ACCOUNT_RESPONSE()
        :m_Hdr(),
         m_Response()
    { };
 ...
 */
    CREATE_ACCOUNT_RESPONSE (DWORD dwResult,
                             WORD  wClientID,
                             DWORD dwSequence,
                             DWORD dwContext)  
 ...
 */
    LOGON_REQUEST(WORD wClientID,         ///< Server provided Client ID 
                  ...
                  DWORD dwContext = 0)    ///< [Optional] field provided for Client's use
...
/// Default Constructor
    constexpr LOGON_RESPONSE()
        : m_Hdr(),
          m_Response()
    { };

/// Initialization Constructor    
    LOGON_RESPONSE(DWORD dwResult,   ///< Server generated cnp::CER_TYPE result
                   WORD  wClientID,  ///< Copied from LOGON_REQUEST
                   DWORD dwSequence, ///< Copied from LOGON_REQUEST
                   DWORD dwContext)  ///< Copied from LOGON_REQUEST
 ...
 *  @note auto increments the Client's global sequence number
 */
    constexpr LOGOFF_REQUEST(WORD  wClientID,      ///< Server generated Client ID
                             DWORD dwContext = 0)  ///< [Optional] Client provided field
...
/// Default Constructor
    constexpr LOGOFF_RESPONSE()
        :m_Hdr(),
         m_Response()
    { };

/// Initialization Constructor
    LOGOFF_RESPONSE(DWORD dwResult,    ///< Server generated cnp::CER_TYPE result
                    WORD  wClientID,   ///< Copied from LOGOFF_REQUEST
                    DWORD dwSequence,  ///< Copied from LOGOFF_REQUEST
                    DWORD dwContext)   ///< Copied from LOGOFF_REQUEST
...
// Server Decoding Helper Methods
    ...
    inline WORD        get_DepositType(void) const
...
/// Initialization Constructor
    DEPOSIT_RESPONSE(DWORD dwResult,   ///< Server generated cnp::CER_TYPE result
                     ...
                     DWORD dwContext)  ///< Copied from DEPOSIT_REQUEST
...
struct WITHDRAWAL_RESPONSE
{
    ...
    WITHDRAWAL_RESPONSE(DWORD dwResult,    ///< Server generated cnp::CER_TYPE result
                        WORD  wClientID,   ///< Copied from WITHDRAWAL_REQUEST
                        DWORD dwSequence,  ///< Copied from WITHDRAWAL_REQUEST
                        DWORD dwContext)   ///< Copied from WITHDRAWAL_REQUEST
...
/// Default constructor
    constexpr BALANCE_QUERY_REQUEST()
        : m_Hdr(),
          m_Request()
    { };
...
/// Initialization Constructor
    BALANCE_QUERY_RESPONSE(DWORD dwResult,   ///< Server generated cnp::CER_TYPE result
                           ...
                           DWORD dwSequence) ///< Copied from BALANCE_QUERY_REQUEST
...
// Server Decoding Helper Methods
    ...
    inline DWORD      get_StartID(void) const
...
/// Initialization Constructor
    TRANSACTION_QUERY_RESPONSE(DWORD dwResult,          ///< Server generated cnp::CER_TYPE result
                               ...
                               DWORD dwContext)         ///< Copied from TRANSACTION_QUERY_REQUEST
 ...
 */
    STAMP_PURCHASE_RESPONSE(DWORD dwResult,
                            WORD  wClientID,
                            DWORD dwSequence,
                            DWORD dwContext)
